    ...
    projects = [
        {
            ...
            livetest: 'https://jennifer-thomas.de/join/index.html'
        },
        {
            name: 'Pollo Loco',
            ...
            livetest: 'https://jennifer-thomas.de/el-pollo-loco/index.html'
        },
        {
            name: 'Pokedex',
            ...
            livetest: 'https://jennifer-thomas.de/pokedex/index.html'
        }
    ];
}
